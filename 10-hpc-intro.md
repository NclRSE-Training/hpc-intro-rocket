...
![A rack half full with servers](fig/servers-openclipartorg-ericlemerdy.svg){alt="A rack half full with servers" width="33%"}
...
![A rack with servers](fig/serverrack-openclipartorg-psteinb-basedon-ericlemerdy.svg){alt="A rack with servers" width="33%"}
